...
class WHU_OHS_Dataset(data.Dataset):
    def __init__(self, image_file_list, label_file_list, ori_label, use_3D_input=False, channel_last=False):
    ...
    def __getitem__(self, index):
        ...
        label_map = {label_i: i for i, label_i in enumerate(self.ori_label)}
        ...
        label = torch.tensor(mapped_labels, dtype=torch.long) - 1
